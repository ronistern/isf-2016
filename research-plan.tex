...
Clearly, an open precondition or an unresolvable causal-link threat pose a PIF. However, additional PIFs may be detected if we have some knowledge about the duration of performing each action and the time when agents plan to perform them. 
